...
export function Footer() {
  return (
    <footer className="border-t border-border/50 bg-background/50 py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-[1200px] px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          <a href="https://github.com/darshan440" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors hover:shadow-[0_0_15px_rgba(139,92,246,0.5)] rounded-full">
